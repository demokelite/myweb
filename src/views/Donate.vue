        ...
        <div class="donate-methods-grid">
          ...
          <div class="donate-method-item card-hover">
            ...
            <div class="donate-method-content">
              <div class="qr-code">
                <div class="qr-code-frame" @click="showQrCode('../assets/images/wechat-qr.jpg', '微信支付二维码')">
                  <img src="../assets/images/wechat-qr.jpg" alt="微信支付二维码" />
          ...
          <div class="donate-method-item card-hover">
            ...
            <div class="donate-method-content">
              <div class="qr-code">
                <div class="qr-code-frame" @click="showQrCode('../assets/images/alipay-qr.jpg', '支付宝二维码')">
                  <img src="../assets/images/alipay-qr.jpg" alt="支付宝二维码" />
                  <div class="qr-code-overlay">
                    <i class="el-icon-camera"></i>
                  </div>
                </div>
          ...
          <div class="donate-method-item card-hover">
            ...
            <div class="donate-method-content">
              ...
              <p class="contact-email">contact@zhishihunzi.com</p>
            </div>
          </div>
        </div>
      </div>
